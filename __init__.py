...
def pref_save(filename='~/.pymolrc_plugins.py', quiet=1):
    ...
    print >> f, __name__ + '.set_startup_path(', repr(get_startup_path()), ')'
    f.close()
...
class PluginInfo:
    ...
    def metadata(self):
        ...
        This property is lazy initialized on first use.
        '''
        metadata = dict()
    ...
    def get_version(self):
        ...
        '''
        v = self.metadata.get('Version')
        if v is None and self.loaded:
